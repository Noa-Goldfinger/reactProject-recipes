const recipe = [
   ...
   ,
    ...
    },
    {
        ...
        Ingrident:[
            {"Name":"אבטיח חתוך לקוביות","Count":1/2,"Type":""},
            {"Name":"מיץ תפוזים","Count":1/4,"Type":"כוס"},
            {"Name":"אבקת סוכר","Count":2,"Type":"כפות"}
        ],
        Instructions:[
    ...
    },
    {
        ...
        Ingrident:[
            {"Name":"בשר","Count":1/2,"Type":"קילו"},
            {"Name":"כוסברה","Count":1,"Type":"חופן"},
            {"Name":"פלפל לבן","Count":1/2,"Type":"כפית"},
            {"Name":"גריל בשר","Count":1/2,"Type":"כפית"},
            {"Name":"מלח","Count":1/2,"Type":"כפית"},
            {"Name":"ביצה","Count":1,"Type":""},
            {"Name":"בצל","Count":1/2,"Type":""},
            {"Name":"רוטב טריאקי","Count":1/3,"Type":"כוס"},
            {"Name":"כמון","Count":1/2,"Type":"כפית"}
        ],
        Instructions:[
