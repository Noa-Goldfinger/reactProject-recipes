...
export default function LabeledValuesSlider({filterDuration}) {
      handleChange = (children) => {
        filterDuration(children);
      };
    return (
    <Box sx={{ width: 200 }}>
      <Slider max={200} LabeledValuesSlider="משך הכנה:" defaultValue={200} slots={{ valueLabel: SliderValueLabel }} />
    </Box>
  );
}
